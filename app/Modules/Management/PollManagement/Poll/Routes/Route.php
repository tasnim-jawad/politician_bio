...
use App\Modules\Management\PollManagement\Poll\Controller\Controller;
...
Route::prefix('v1')->group(function () {
    Route::prefix('polls')->group(function () {
        ...
        Route::get('{id}/check-vote', [Controller::class, 'checkVote']);
        Route::post('{id}/vote', [Controller::class, 'submitVote']);
        Route::get('{id}/results', [Controller::class, 'getPollResults']);
    });
});