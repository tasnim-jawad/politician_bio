...
include_once base_path("app/Modules/Management/WhyChoseUsManagement/WhyChoseUs/Routes/Route.php");
...
include_once base_path("app/Modules/Management/VolunteerManagement/Volunteer/Routes/Route.php");
include_once base_path("app/Modules/Management/GalaryManagement/GalleryCategory/Routes/Route.php");
include_once base_path("app/Modules/Management/GalaryManagement/Image/Routes/Route.php");
include_once base_path("app/Modules/Management/GalaryManagement/video/Routes/Route.php");
include_once base_path("app/Modules/Management/IssuesManagement/Issues/Routes/Route.php");
include_once base_path("app/Modules/Management/GetInvolvedManagement/GetInvolved/Routes/Route.php");
...
include_once base_path("app/Modules/Management/NewsManagement/NewsCategory/Routes/Route.php");
include_once base_path("app/Modules/Management/NewsManagement/News/Routes/Route.php");
