        ...
        <div class="card" id="home_page_headings">
          <div class="card-body">
            <div class="d-flex">
              ...
              >
                <li class="nav-item" @click="tab = 'team_volunteer'">
                  <a
                    :class="tab == 'team_volunteer' ? ' active' : ''"
                    href="javascript:void();"
                    data-target="#team_volunteer"
                    data-toggle="pill"
                    class="nav-link"
                    ><i class="icon-note"></i>
                    <span class="hidden-xs">Volunteer</span></a
                  >
                  <hr />
                </li>
              </ul>
