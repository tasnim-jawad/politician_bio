        ...
        <div class="card" id="home_page_headings">
          <div class="card-body">
            <div class="d-flex">
              ...
              >
                <li class="nav-item" @click="tab = 'history_timeline'">
                  <a
                    :class="tab == 'history_timeline' ? ' active' : ''"
                    href="javascript:void();"
                    data-target="#history_timeline"
                    data-toggle="pill"
                    class="nav-link"
                    ><i class="icon-note"></i>
                    <span class="hidden-xs">History Timeline</span></a
                  >
                  <hr />
                </li>
              </ul>
