                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-9">
                        <input
                          ...
                          :value="`${get_setting_value('fax_number')}`"
                        />
                      </div>
                    </div>
                    <!-- Address -->
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-9">
                        <input
                          ...
                          :value="`${get_setting_value('main_color_one')}`"
                        />
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-9">
                        <input
                          ...
                          :value="`${get_setting_value('main_color_two')}`"
                        />
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-lg-9">
                        <input
                          ...
                          :value="`${get_setting_value('secondary_color')}`"
                        />
                      </div>
                    </div>
  ...
  methods: {
    ...
    SiteSettingsHandler: async function () {
      ...
      if (response.data.status == "success") {
        ...
        // Update CSS variables if theme colors were changed
