        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title-area ltn__section-title-2--- text-center">
                    <h6 class="section-subtitle section-subtitle-2 ltn__secondary-color">Properties Listings</h6>
                    <h1 class="section-title">luxury Properties</h1>
                </div>
            </div>
        </div>
        <div class="row">
            @foreach ( $properties['Luxury'] as $property )
                <div class="col-lg-4">
                        ...
                        <div class="product-img">
                            ...
                            <div class="product-img-location-gallery">
                                ...
                                <div class="product-img-gallery">
                                    <ul>
                                        <li>
                                            <a href="product-details.html"><i class="fas fa-camera"></i> {{ count($property?->banner_image ?? []) }}</a>
                                        </li>
                                        <li>
                                            <a href="product-details.html"><i class="fas fa-film"></i> {{ count($property?->banner_image ?? []) }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="product-img">
                        ...
                        <div class="product-img-location-gallery">
                            <div class="product-img-location">
                                <ul>
                                    <li>
                                        <a href="locations.html"><i class="flaticon-pin"></i> Bashundhara, Dhaka</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="product-img-gallery">
